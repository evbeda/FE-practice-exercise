...
export const HeartButton = () => {
  return (
    <div className="eds-event-card-content__actions-container eds-event-card-content__actions-container--consumer eds-event-card-content__actions-container--always-visible">
      <span className="eds-event-card__actions-id__412875932027 eds-event-card-content__actions-container__action eds-l-pad-all-1 eds-event-card-content__actions-icon--primary">
        <span className="eds-icon-button eds-icon-button--neutral" data-spec="icon-button">
          <button aria-pressed="false" className="eds-btn--button eds-btn--none eds-btn--icon-only" type="button">
